...
<body>
	...
	<h1>게시글 작성페이지</h1>
		...
		<%-- 
			...
			>> 전송방식이 post로 한정(이유:get방식은 url에 값이 한정되어있어서)
			>> 파일 전송시에, 인코딩되지 않도록 설정
			   form 태그의 enctype을 "multipart/form-data"로 지정해야 한다.(파일이면 다 해야 함)
		--%>
		...
		<form action="write" method="post" enctype="multipart/form-data">
			<table id="list">
				...
				<tr>
					<td>작성자</td>
					<!--  
						readonly 수정은 안되지만 데이터전송은 된다.
						disabled는 수정은 안되지만 데이터 전송도 막는 방법
					-->
